...
void menu_stack_type(){
	...
	printf("3. Информация о времени\n");

	printf("\n");
}

void menu_operations_array(){
	printf("\n");
	printf("ОПЕРАЦИИ: \n");
	...
	printf("4. Показать полученные слова");
	...
	if(option == 3){
		{
			...
			printf("Время PUSH для массива: %f\n", push_arr);
			...
			printf("\n-------------\n");
			printf("Время POP для массива: %f\n", pop_arr);
